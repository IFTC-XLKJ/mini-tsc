...
#if defined(TS_NEED_node_path_join)
...
#endif /* TS_NEED_node_path_join */

#if defined(TS_NEED_node_path_resolve)
...
#endif /* TS_NEED_node_path_resolve */

#if defined(TS_NEED_node_path_basename)
...
#endif /* TS_NEED_node_path_basename */

#if defined(TS_NEED_node_path_dirname)
...
#endif /* TS_NEED_node_path_dirname */

#if defined(TS_NEED_node_path_extname)
...
#endif /* TS_NEED_node_path_extname */

#if defined(TS_NEED_node_path_normalize)
Value node_path_normalize(Value path) {
  TSString* pathStr = ts_to_string(path);
  /* Simplified: just return as-is */
  return ts_value_string(ts_string_new(pathStr->data));
}
#endif /* TS_NEED_node_path_normalize */

#if defined(TS_NEED_node_path_isAbsolute)
...
#endif /* TS_NEED_node_path_isAbsolute */

#if defined(TS_NEED_node_path_parse)
...
#endif /* TS_NEED_node_path_parse */

#if defined(TS_NEED_node_path_format)
...
#endif /* TS_NEED_node_path_format */

#if defined(TS_NEED_node_path_relative)
...
#endif /* TS_NEED_node_path_relative */
