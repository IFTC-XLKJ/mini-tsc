...
#if defined(TS_NEED_node_process_env)
...
#endif /* TS_NEED_node_process_argv */

#if defined(TS_NEED_node_process_cwd)
...
#endif /* TS_NEED_node_process_cwd */

#if defined(TS_NEED_node_process_chdir)
int node_process_chdir(Value dir) {
  TSString* dirStr = ts_to_string(dir);
  return chdir_fn(dirStr->data);
}
#endif /* TS_NEED_node_process_chdir */

#if defined(TS_NEED_node_process_exit)
void node_process_exit(Value code) {
  int exitCode = (int)ts_to_number(code);
  exit(exitCode);
}
#endif /* TS_NEED_node_process_exit */

#if defined(TS_NEED_node_process_pid)
...
#endif /* TS_NEED_node_process_pid */
...
#if defined(TS_NEED_node_process_stdin)
...
#endif /* TS_NEED_node_process_stdin */

#if defined(TS_NEED_node_process_stdout)
...
#endif /* TS_NEED_node_process_stdout */

#if defined(TS_NEED_node_process_stderr)
...
#endif /* TS_NEED_node_process_stderr */
...
#if defined(TS_NEED_node_process_stdout_write)
Value node_process_stdout_write(Value data) {
  return stream_write(stdout, data);
}
#endif /* TS_NEED_node_process_stdout_write */

#if defined(TS_NEED_node_process_stderr_write)
Value node_process_stderr_write(Value data) {
  return stream_write(stderr, data);
}
#endif /* TS_NEED_node_process_stderr_write */

#if defined(TS_NEED_node_process_stdout_cursorTo)
Value node_process_stdout_cursorTo(Value x, Value y) {
  return stream_cursor_to(stdout, x, y);
}
#endif /* TS_NEED_node_process_stdout_cursorTo */

#if defined(TS_NEED_node_process_stderr_cursorTo)
Value node_process_stderr_cursorTo(Value x, Value y) {
  return stream_cursor_to(stderr, x, y);
}
#endif /* TS_NEED_node_process_stderr_cursorTo */

#if defined(TS_NEED_node_process_stdout_moveCursor)
Value node_process_stdout_moveCursor(Value dx, Value dy) {
  return stream_move_cursor(stdout, dx, dy);
}
#endif /* TS_NEED_node_process_stdout_moveCursor */

#if defined(TS_NEED_node_process_stderr_moveCursor)
Value node_process_stderr_moveCursor(Value dx, Value dy) {
  return stream_move_cursor(stderr, dx, dy);
}
#endif /* TS_NEED_node_process_stderr_moveCursor */

#if defined(TS_NEED_node_process_stdout_clearScreenDown)
Value node_process_stdout_clearScreenDown(void) {
  return stream_clear_screen_down(stdout);
}
#endif /* TS_NEED_node_process_stdout_clearScreenDown */

#if defined(TS_NEED_node_process_stderr_clearScreenDown)
Value node_process_stderr_clearScreenDown(void) {
  return stream_clear_screen_down(stderr);
}
#endif /* TS_NEED_node_process_stderr_clearScreenDown */

#if defined(TS_NEED_node_process_stdout_clearLine)
Value node_process_stdout_clearLine(Value dir) {
  return stream_clear_line(stdout, dir);
}
#endif /* TS_NEED_node_process_stdout_clearLine */

#if defined(TS_NEED_node_process_stderr_clearLine)
Value node_process_stderr_clearLine(Value dir) {
  return stream_clear_line(stderr, dir);
}
#endif /* TS_NEED_node_process_stderr_clearLine */

#if defined(TS_NEED_node_process_openUrl)
...
#endif /* TS_NEED_node_process_openUrl */
