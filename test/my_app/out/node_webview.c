...
#if defined(TS_NEED_node_webview_navigate)
Value node_webview_navigate(Value self, Value url) {
  return node_webview_loadURL(self, url);
}
#endif /* TS_NEED_node_webview_navigate */

#if defined(TS_NEED_node_webview_loadHTML)
Value node_webview_loadHTML(Value self, Value html) {
  (void)self; (void)html;
  /* TODO: Implement NavigateToString */
  return ts_value_undefined();
}
#endif /* TS_NEED_node_webview_loadHTML */

#if defined(TS_NEED_node_webview_evaluate)
Value node_webview_evaluate(Value self, Value script) {
  (void)self; (void)script;
  /* TODO: Implement ExecuteScript */
  return ts_value_undefined();
}
#endif /* TS_NEED_node_webview_evaluate */

#if defined(TS_NEED_node_webview_executeJavaScript)
...
#endif /* TS_NEED_node_webview_executeJavaScript */

#if defined(TS_NEED_node_webview_setTitle)
...
#endif /* TS_NEED_node_webview_setTitle */

#if defined(TS_NEED_node_webview_setSize)
...
#endif /* TS_NEED_node_webview_setSize */

#if defined(TS_NEED_node_webview_setIcon)
Value node_webview_setIcon(Value self, Value iconPath) {
  (void)self; (void)iconPath;
  /* TODO: Implement icon setting */
  return ts_value_undefined();
}
#endif /* TS_NEED_node_webview_setIcon */

#if defined(TS_NEED_node_webview_setPosition)
...
#endif /* TS_NEED_node_webview_setPosition */

#if defined(TS_NEED_node_webview_center)
...
#endif /* TS_NEED_node_webview_center */

#if defined(TS_NEED_node_webview_show)
...
#endif /* TS_NEED_node_webview_show */

#if defined(TS_NEED_node_webview_hide)
...
#endif /* TS_NEED_node_webview_hide */

#if defined(TS_NEED_node_webview_focus)
...
#endif /* TS_NEED_node_webview_focus */

#if defined(TS_NEED_node_webview_minimize)
...
#endif /* TS_NEED_node_webview_minimize */

#if defined(TS_NEED_node_webview_maximize)
...
#endif /* TS_NEED_node_webview_maximize */

#if defined(TS_NEED_node_webview_unmaximize)
...
#endif /* TS_NEED_node_webview_unmaximize */

#if defined(TS_NEED_node_webview_close)
...
#endif /* TS_NEED_node_webview_close */
...
#endif /* TS_NEED_node_webview_get_url */
